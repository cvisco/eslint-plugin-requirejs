 ...
 * @returns {Boolean} true if has a CommonJS Wrapper parameter list
 */
 ...
 * @returns {Boolean} true if current function is a module definition
 */
...
function getDependencyStringNodes(node) {
    const nodes = getDependencyNodes(node) || [];

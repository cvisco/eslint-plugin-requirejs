...
[
    ...
    "./AMD_DEFINE",
    "./AMD_EMPTY_DEFINE",
    "./AMD_DEFINE_TOO_FEW_CALLBACK_PARAMS",
    "./AMD_DEFINE_TOO_MANY_CALLBACK_PARAMS",
    "./AMD_NAMED_DEFINE_TOO_FEW_CALLBACK_PARAMS",
    "./AMD_NAMED_DEFINE_TOO_MANY_CALLBACK_PARAMS",
    "./CJS_WITH_RETURN",
    ...
    "./NAMED_CJS_DEFINE",
    "./AMD_REQUIRE",
    "./AMD_REQUIRE_CALLEXPRESSION_CALLBACK",
    "./AMD_REQUIRE_MEMBEREXPRESSION_CALLBACK",
    "./AMD_REQUIRE_IDENTIFIER_CALLBACK",
    "./AMD_EMPTY_REQUIRE",
    "./AMD_REQUIRE_WITH_ERRBACK",
    "./AMD_REQUIRE_RELATIVE",
    "./AMD_REQUIREJS",
    "./AMD_REQUIREJS_CALLEXPRESSION_CALLBACK",
    "./AMD_REQUIREJS_MEMBEREXPRESSION_CALLBACK",
    "./AMD_REQUIREJS_IDENTIFIER_CALLBACK",
    "./AMD_REQUIRE_SINGLEDEP_TOO_FEW_CALLBACK_PARAMS",
    "./AMD_REQUIRE_SINGLEDEP_TOO_FEW_CALLBACK_PARAMS_WITH_ERRBACK",
    "./AMD_REQUIRE_SINGLEDEP_TOO_MANY_CALLBACK_PARAMS",
    "./AMD_REQUIRE_SINGLEDEP_TOO_MANY_CALLBACK_PARAMS_WITH_ERRBACK",
    "./AMD_REQUIRE_TOO_FEW_CALLBACK_PARAMS",
    "./AMD_REQUIRE_TOO_FEW_CALLBACK_PARAMS_WITH_ERRBACK",
    "./AMD_REQUIRE_TOO_MANY_CALLBACK_PARAMS",
    "./AMD_REQUIRE_TOO_MANY_CALLBACK_PARAMS_WITH_ERRBACK",
    "./AMD_REQUIREJS_SINGLEDEP_TOO_FEW_CALLBACK_PARAMS",
    "./AMD_REQUIREJS_SINGLEDEP_TOO_FEW_CALLBACK_PARAMS_WITH_ERRBACK",
    "./AMD_REQUIREJS_SINGLEDEP_TOO_MANY_CALLBACK_PARAMS",
    "./AMD_REQUIREJS_SINGLEDEP_TOO_MANY_CALLBACK_PARAMS_WITH_ERRBACK",
    "./AMD_REQUIREJS_TOO_FEW_CALLBACK_PARAMS",
    "./AMD_REQUIREJS_TOO_FEW_CALLBACK_PARAMS_WITH_ERRBACK",
    "./AMD_REQUIREJS_TOO_MANY_CALLBACK_PARAMS",
    "./AMD_REQUIREJS_TOO_MANY_CALLBACK_PARAMS_WITH_ERRBACK",
    "./AMD_EMPTY_REQUIREJS",
    ...
    "./DYNAMIC_VARIABLE_AMD_DEFINE",
    "./DYNAMIC_VARIABLE_AMD_NAMED_DEFINE",
    ...
    "./BAD_REQUIRE_INVALID_CALLBACK_ARRAY",
    "./BAD_REQUIRE_INVALID_ERRBACK",
    "./BAD_REQUIRE_INVALID_ERRBACK_ARRAY",
    "./UNWRAPPED_FILE",
